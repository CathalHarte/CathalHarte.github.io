...
Sources for every factual claim on the site. Where a claim originates in conversation with me rather than a published source, it is attributed to **Cathal Harte (direct)**.
...
| Claim | Source |
|---|---|
| "I build medical devices at the frontier of neurotechnology and nuclear medicine" | Cathal Harte (direct) |
| "from laboratory prototypes to systems deployed in patients' homes" | Cathal Harte (direct) |
...
| Claim | Source |
|---|---|
| Badge: "ISO 13485:2016 Certified" | [Terapet news](https://terapet.ch/terapet-achieves-iso-134852016-certification/) |
| "Total-body PET imaging · CERN spin-off technology" | [CERN KT](https://kt.cern/startups/terapet) + [Terapet website](https://terapet.ch/) |
| Full card description (acquisition, reconstruction, risk management, proton therapy QA) | Cathal Harte (direct) |
| PTCOG 2026 link | [Terapet website](https://terapet.ch/ptcog-2026/) |
...
| Claim | Source |
|---|---|
| "I'd like to stress the substantial development effort we made to enable the system to be used at home. That's what makes the achievement all the more real for me." | [Silicon Republic, 2023](https://www.siliconrepublic.com/machines/spinal-cord-stimulation-neurorestore-cathal-harte) |

---

## Press links (neurotech.html)
...
- The claim "Physics World Breakthrough of the Year" was not initially provided by Cathal — it was sourced from the Physics World website during research for this project. Cathal confirmed it was accurate.
- Job titles, employment dates, and the description of day-to-day responsibilities at Terapet all originate with Cathal Harte (direct) and have not been independently verified against public sources.
- The description of Qualγscan as applying "the same underlying technology" for proton therapy QA originates with Cathal Harte (direct).
